...
//char * idea_filename[4] = {"idea_traces_k1k3k5.csv", "idea_traces_k2k4k6.csv", "idea_traces_k7k9k10.csv", "idea_traces_k8k11k12.csv"};
char * idea_filename[4] = {"idea500_traces.csv", "Xaes_traces.csv", "aes_traces.csv", "Xaes_traces.csv"};
uint16_t idea_key_found[8];
...
uint16_t *  blockCipher(uint16_t * pt, uint16_t * subkey, int tag);
